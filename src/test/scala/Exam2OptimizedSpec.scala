...
class Exam2OptimizedSpec extends FlatSpec {
  ...
  it should "findSqrtIntOffset for 9" in {
    Exam2Optimized.findSqrtIntOffset(9) should equal((3, 0, 7))
  }

  it should "findSqrtIntOffset for 6561" in {
    Exam2Optimized.findSqrtIntOffset(6561) should equal((81, 0, 163))
  }

  it should "findSqrtIntOffset for 10" in {
    Exam2Optimized.findSqrtIntOffset(10) should equal((4, 6, 9))
  }
